  ...
  <div class="container-fluid">
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        ...
        <li class="bg_ls span2"> <a href="staffs.php" style="font-size: 16px;"> <i class="fas fa-briefcase"></i> Staff Management </a> </li>
          ...
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                ...
                <li class="bg_ly"><i class="fas fa-file-invoice"></i> <strong>₹<?php include 'actions/total-exp.php';?></strong> <small>Total Expenses</small></li>
