        ...
        <thead>
          <tr>
            ...
            echo"<tbody> 
                ...
                <td><div class='text-center'><a href='user-payment.php?id=".$row['user_id']."'><button class='btn btn-success btn-mini'><i class='icon icon-rupee'></i> Make Payment</button></a></div></td>
